...
public interface TitleReignRepository extends JpaRepository<TitleReign, UUID> {
    ...
    Optional<TitleReign> findFirstByChampionship_IdAndIsCurrentTrueOrderByStartDateDesc(UUID championshipId);

    List<TitleReign> findByWrestlerIdOrderByStartDateDesc(UUID wrestlerId);
}
